...
class TestTurtleBot(unittest.TestCase):
    ...
    def test_history(self):
        self.t.move_forward(100)
        self.t.move_backward(100)
        self.t.turn_right()
        self.t.turn_left()
        self.assertEqual(self.t.history(), [('forward', 100), ('backward', 100), ('right', 90), ('left', 90)], "Erreur dans l'historique")
    ...
    def test_unplay(self):
        ...
        self.t.turn_left()
        self.t.unplay()
        self.assertEqual(self.t.position(), (0,0), "Erreur dans l'inverse des mouvements")
        self.assertEqual(self.t.history(), [], 'Historique non supprimé')
